...
function _buildAccountHTML(accountName, accountId, analysis, generatedAt) {
  ...
  <div class="rpt-page rpt-pb">
    <div class="rpt-tag">Section 03 — Evidence Chain</div>
  ...
  <div class="rpt-page rpt-pb">
    <div class="rpt-tag">Section 02 — Recovery Plan</div>
  ...
  return cover + findingSection + actionsSection + evidenceSection + _methodology() + footer;
}
